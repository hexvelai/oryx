        ...
        <div className="flex-1 flex flex-col items-center justify-center px-6 gap-6">
          <div className="relative">
            <div className="w-16 h-16 rounded-2xl bg-card border border-border flex items-center justify-center">
              <Crown className="w-8 h-8 text-ai-master" />
            </div>
            <div className="absolute -bottom-1 -right-1 w-5 h-5 rounded-full bg-ai-master flex items-center justify-center">
          ...
          <div className="text-center space-y-2">
            ...
            <p className="text-sm text-muted-foreground max-w-md text-balance">
              Nexus routes your prompts to the best AI for the job. Or switch to Teamwork mode for collaborative AI problem-solving.
            </p>
          </div>
          <div className="flex gap-2">
            <button
              onClick={() => startTeamwork("Help me design the architecture for a real-time collaboration app")}
              className="px-4 py-2 rounded-lg bg-card border border-border text-sm text-foreground hover:bg-accent transition-colors active:scale-95"
            >
              🤝 Try Teamwork
            </button>
            <button
