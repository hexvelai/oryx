...
export const AI_MODELS: Record<AIProvider, AIModel> = {
  ...
  "free-autorouter": {
    id: "free-autorouter",
    name: "free autorouter",
    fullName: "openrouter/free",
    color: "ai-free-autorouter",
    description: "OpenRouter — Free Autorouter",
  },
  dolphin: {
    id: "dolphin",
    name: "Dolphin",
  ...
  "deepseek-chat": {
    ...
    color: "ai-deepseek-chat",
    description: "DeepSeek API — DeepSeek Chat (V3.2, 128K)",
  },
  "deepseek-reasoner": {
    id: "deepseek-reasoner",
    name: "DeepSeek Reasoner",
    fullName: "deepseek-reasoner",
    color: "ai-deepseek-reasoner",
    description: "DeepSeek API — DeepSeek Reasoner (V3.2, 128K)",
  },
};

export function getAIModel(id: unknown): AIModel | undefined {
  if (typeof id !== "string") return undefined;
  return (AI_MODELS as Record<string, AIModel>)[id];
}
